...
void initCamera(void)
{
	...
	i2c_write(OUTPUT_CONTROL_REG, ((2<<10)|(4<<7)|(1<<1)));		// OK!
	...
	*/
	// red
	i2c_write(GAIN_RED_REG, (3<<8) | (1<<6) | 32);
	// green 1
	i2c_write(GAIN_GREEN1_REG, (3<<8) | (1<<6) | 32);
	// green 2
	i2c_write(GAIN_GREEN2_REG, (3<<8) | (1<<6) | 32);
	// blue
	i2c_write(GAIN_BLUE_REG, (7<<8) | (1<<6) | 32);
	...
	// default 0x797
	i2c_write(SHUTTERW_LOWER_REG, 250);					// schaut halbwegs OK aus! hoher wert --> kleinere framerate
