...
add wave -noupdate -format Logic /top_tb/top_1/cam0/pixclk
...
add wave -noupdate -format Logic /top_tb/top_1/cam0/convert
...
add wave -noupdate -group {DP RAM W} -color {Cornflower Blue} -format Logic /top_tb/top_1/cam0/dp_wren
add wave -noupdate -group {DP RAM W} -color {Cornflower Blue} -format Literal -radix hexadecimal /top_tb/top_1/cam0/dp_wraddr
add wave -noupdate -group {DP RAM W} -color {Cornflower Blue} -format Literal -radix hexadecimal /top_tb/top_1/cam0/dp_data
...
add wave -noupdate -expand -group {DP RAM R} -color {Cornflower Blue} -format Literal -radix unsigned /top_tb/top_1/dispctrl0/rdaddress
add wave -noupdate -expand -group {DP RAM R} -color {Cornflower Blue} -format Literal -radix hexadecimal /top_tb/top_1/dispctrl0/rddata
...
WaveRestoreCursors {{Cursor 1} {45750000 ps} 0}
...
update
WaveRestoreZoom {45599872 ps} {45900128 ps}
